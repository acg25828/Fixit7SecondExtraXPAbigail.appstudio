...
const cacheName = 'Fixit7SecondExtraXPAbigail-2020-10-21 13:54:45.115448'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Fixit7SecondExtraXPAbigail'.length) === 'Fixit7SecondExtraXPAbigail') {
